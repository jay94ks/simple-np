...
*/
uint8_t ST7735_TFT_graphics ::TFTdrawText(uint8_t x, uint8_t y, const char *pText, uint16_t color, uint16_t bg, uint8_t size)
{
...
/*!
	...
	@note for font 7-12 only
*/
uint8_t ST7735_TFT_graphics ::TFTdrawText(uint8_t x, uint8_t y, const char *pText, uint16_t color, uint16_t bg)
{
